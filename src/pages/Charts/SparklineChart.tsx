        ...
        <div className="container-fluid">
          ...
          <Row>
            <Col sm={4}>
              <Card>
                <CardHeader>
                  <h4 className="card-title mb-0">Spots Chart</h4>
                </CardHeader>
                <CardBody>
                  <Sparklines
                    height={100}
          ...
          <Row>
            <Col sm={4}>
              <Card>
                <CardHeader>
                  <h4 className="card-title mb-0">Composite Bar Chart</h4>
                </CardHeader>
                <CardBody>
                  <Sparklines
                    height={100}
            ...
            <Col sm={4}>
              <Card>
                <CardHeader>
                  <h4 className="card-title mb-0">Reference Line Chart</h4>
                </CardHeader>
                <CardBody>
                  <Sparklines
                    height={100}
            ...
            <Col sm={4}>
              <Card className="bg-success mb-4">
                <CardHeader>
                  <h4 className="card-title mb-0">Real World Chart</h4>
                </CardHeader>
                <CardBody>
                  <Sparklines
                    height={80}
          ...
          <Row>
            <Col sm={4}>
              <Card>
                <CardHeader>
                  <h4 className="card-title mb-0">Normal Band</h4>
                </CardHeader>
                <CardBody>
                  <Sparklines
                    height={100}
