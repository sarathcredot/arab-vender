                  ...
                  <div className="d-flex flex-wrap gap-3">
                    ...
                    <div className="btn-group">
                      <ButtonDropdown
                        ...
                        toggle={() =>
                          setDrp_menualignMentLeft(!drp_menualignMentLeft)
                        }
                        className="dropdown-toggle"
                      >
                        <DropdownToggle color="secondary" className="dropdown-toggle">
                    ...
                    <div className="btn-group">
                      <ButtonDropdown
                        ...
                        toggle={() =>
                          setDrp_menualignMentRight(!drp_menualignMentRight)
                        }
                        className="dropdown-toggle"
                      >
                        <DropdownToggle color="secondary" className="dropdown-toggle">
            ...
            <Col xl={6}>
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    Trigger dropdown menus at the down of the elements by adding{" "}
                    <code>.dropdown</code> to the parent element.
                  </p>
                </CardHeader>
                <CardBody>
                  <div className="d-flex gap-2 flex-wrap">
