              ...
              <Card>
                ...
                <CardBody>
                  ...
                  <Alert color="light">
                    ...
                    <Link className="alert-link" to="#">an example link</Link>. Give it a click if you
                    like.
                  </Alert>
                  <Alert color="dark" className="mb-0">
            ...
            <Col xl={6}>
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    Add <code>.alert-top-border</code> class with for top
                    alerts.
                  </p>
                </CardHeader>
            ...
            <Col xl={12}>
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    Alert label add <code>.alert-heading</code> class with
