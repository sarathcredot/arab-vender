...
import { Card, Row, Col, CardBody, Container, CardHeader } from "reactstrap";
              ...
              <Card>
                ...
                <CardBody>
                  ...
                  <h5 className="mb-3">
                    ...
                    <small className="text-muted">1.09375rem (17.5px)</small>
                  </h5>
              ...
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    ...
                    your document. Wrap <code className="highlighter-rouge">
