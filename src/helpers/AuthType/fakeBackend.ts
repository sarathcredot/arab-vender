...
const fakeBackend = () => {
  ...
  mock.onPost(url.ADD_NEW_INBOX_MAIL).reply((inboxmail: any) => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
  ...
  mock.onDelete(url.DELETE_INBOX_MAIL).reply((config: any) => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
  ...
  mock.onDelete(url.DELETE_USER).reply((config: any) => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        if (config && config.headers) {
          // Passing fake JSON data as response
  ...
  mock.onDelete(url.DELETE_PROJECT).reply((config: any) => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        if (config && config.headers) {
          // Passing fake JSON data as response
