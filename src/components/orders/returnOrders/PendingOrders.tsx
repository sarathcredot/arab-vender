  ...
  const {
    ...
    variables: {
      input: {
        ...
        ...(filterData.returnRequestStartDate && {
          returnRequestStartDate: filterData.returnRequestStartDate,
        }),
        ...(filterData.returnRequestEndDate && {
          returnRequestEndDate: filterData.returnRequestEndDate,
        }),
                    ...
                    <Tbody>
                      {orders?.map((order, index) => (
                        <Tr key={order?._id}>
                          ...
                          <Td>
                            {moment(order?.returnRequestDate).format("ll")}
                          </Td>
                          <Td>
                            <div
                              style={{
                          ...
                          <Td>
                            ...
                            order.username
                              ...
                              : order?.shippingAddress?.firstname
                              ? capitalCase(order?.shippingAddress?.firstname)
                              : ""}
                          </Td>
                          ...
                          <Td>
                            ...
                            >
                              ...
                              >
                                ...
                                <div>{formatCurrency(order?.sellingPrice)}</div>
                                {/* <div>
                          ...
                          <Td>
                            <Button
                              ...
                              onClick={() =>
                                navigate(
                                  `/return-orders/details?orderId=${order.orderId}&_id=${order?._id}`
                                )
                              }
                            >
                              View
