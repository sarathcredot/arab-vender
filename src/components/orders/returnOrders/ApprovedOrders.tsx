    ...
    const {
        ...
        variables: {
            input: {
                ...
                ...((filterData.returnRequestStartDate) && { returnStartDate: filterData.returnRequestStartDate }),
                ...((filterData.returnRequestEndDate) && { returnEndDate: filterData.returnRequestEndDate }),
