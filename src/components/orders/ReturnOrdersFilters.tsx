...
const ReturnOrdersFilters: React.FC<AllOrderFiltersProps> = ({ onSubmit }) => {
            ...
            <CardBody>
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-around" }}>
                        ...
                        <div style={{ width: "200px" }}>
                            <FormGroup>
                                <Label for="returnRequestStartDate">Start Date</Label>
                                <Input
                                    type="date"
                                    name="returnRequestStartDate"
                                    id="returnRequestStartDate"
                                    value={formData.returnRequestStartDate}
                                    onChange={handleChange}
                                />
                            </FormGroup>
                        </div>
                        <div style={{ width: "200px" }}>
                            <FormGroup>
                                <Label for="returnRequestEndDate">End Date</Label>
                                <Input
                                    type="date"
                                    name="returnRequestEndDate"
                                    id="returnRequestEndDate"
                                    value={formData.returnRequestEndDate}
                                    onChange={handleChange}
                                />
                            </FormGroup>
                        </div>
...
export default ReturnOrdersFilters